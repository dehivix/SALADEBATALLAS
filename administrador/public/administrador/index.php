	...
	<div id="content-box">
        ...
        <div class="m" >
						...
						<tr>
							...
							<td width="55%" valign="top"><strong>
						    <h3>&nbsp;&nbsp;Datos del Administrador</h3></strong>&nbsp;
						    <table width="502" border="0" cellspacing="0">
                                  <tr>
                                    <td>Usuario:</td>
                                    <td><strong><?php echo $_SESSION["usuario"]; ?></strong></td>
                                  </tr>
                                  <tr>
                                    <td width="169">C&eacute;dula:</td>
                                    <td width="329"><b><?php echo $_SESSION["cedula"];?></b>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Nombres:</td>
                                    <td><strong><?php echo $_SESSION["nombres"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Apellidos:</td>
                                    <td><strong><?php  echo $_SESSION["apellidos"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Sexo:</td>
                                    <td><strong><?php echo $_SESSION["sexo"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Fecha de Nacimiento:</td>
                                    <td><strong><?php echo $_SESSION["fecha"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Direcci&oacute;n:</td>
                                    <td><strong><?php echo $_SESSION["direccion"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Tlf Celular:</td>
                                    <td><strong><?php echo $_SESSION["celular"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Tlf Casa:</td>
                                    <td><strong><?php echo $_SESSION["telecasa"];?></strong>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Password:</td>
                                    <td><strong><?php echo $_SESSION["clave"];?></strong>&nbsp;</td>
                                  </tr>
                                </table>
